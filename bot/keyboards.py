...
def get_keys_menu(user_keys, selected_key_id=None):
    ...
    for index, (key_id, key_value, created_at, status) in enumerate(user_keys, start=1):
        ...
        if selected_key_id == key_id:
            if keys_count == 1:
                keyboard.append([
                    InlineKeyboardButton(text="🔑 Получить", callback_data=f"connect_key_{key_id}"),
                    InlineKeyboardButton(text="🌍 Изменить", callback_data=f"replace_key_{key_id}")
                ])
            else:
                keyboard.append([
                    InlineKeyboardButton(text="🔑 Получить", callback_data=f"connect_key_{key_id}"),
                    InlineKeyboardButton(text="🔥 Удалить", callback_data=f"ask_delete_key_{key_id}"),
                    InlineKeyboardButton(text="🌍 Изменить", callback_data=f"replace_key_{key_id}")
                ])
...
def get_admin_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🔑 Ключи пользователя", callback_data="admin_user_keys")],
        [InlineKeyboardButton(text="📢 Рассылка", callback_data="admin_broadcast")],
        [InlineKeyboardButton(text="📜 Логи админа", callback_data="admin_logs")],
        [InlineKeyboardButton(text="🗑 Удалить ключ пользователя", callback_data="admin_delete_key")],
...
def get_admin_balance_amounts_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="100₽", callback_data="admin_balance_amount_100"),
            InlineKeyboardButton(text="200₽", callback_data="admin_balance_amount_200"),
            InlineKeyboardButton(text="300₽", callback_data="admin_balance_amount_300"),
        ],
        [
            InlineKeyboardButton(text="400₽", callback_data="admin_balance_amount_400"),
            InlineKeyboardButton(text="500₽", callback_data="admin_balance_amount_500"),
            InlineKeyboardButton(text="Другое", callback_data="admin_balance_amount_other"),
        ],
        [InlineKeyboardButton(text="↩️ Назад в админку", callback_data="admin_main")]
    ])
...
def get_admin_user_keys_keyboard(user_keys):
    ...
    keyboard.append([InlineKeyboardButton(text="↩️ Назад в админку", callback_data="admin_main")])
    return InlineKeyboardMarkup(inline_keyboard=keyboard)


def get_admin_single_key_keyboard(key_id):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="🗑 Удалить ключ", callback_data=f"admin_key_ask_delete_{key_id}")],
        [InlineKeyboardButton(text="⬅️ Назад к ключам", callback_data="admin_user_keys_back")],
        [InlineKeyboardButton(text="↩️ Назад в админку", callback_data="admin_main")]
    ])
...
def get_admin_delete_confirm_keyboard(key_id):
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="🔥 Да, удалить", callback_data=f"admin_key_confirm_delete_{key_id}"),
            InlineKeyboardButton(text="❌ Отмена", callback_data=f"admin_key_select_{key_id}")
        ],
        [InlineKeyboardButton(text="⬅️ Назад к ключам", callback_data="admin_user_keys_back")],
        [InlineKeyboardButton(text="↩️ Назад в админку", callback_data="admin_main")]
    ])
...
def get_broadcast_mode_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Только текст", callback_data="admin_broadcast_send_plain")],
        [InlineKeyboardButton(text="Текст + кнопки", callback_data="admin_broadcast_send_buttons")],
        [InlineKeyboardButton(text="↩️ Назад в админку", callback_data="admin_main")]
    ])
...
def get_broadcast_preview_plain_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="✅ Отправить всем", callback_data="admin_broadcast_confirm_send"),
